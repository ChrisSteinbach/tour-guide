...
// Shewchuk's adaptive-precision orient3d predicate
...
function finadd(finlen: number, alen: number, a: Float64Array): number {
...
function orient3dadapt(
  ...
  let adztail: number, bdztail: number, cdztail: number;
  let bvirt: number,
    c: number,
    ahi: number,
    alo: number,
